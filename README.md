...
| Deep Learning | A collection of deep learning projects, including Fashion MNIST image classification and smart garbage classification using modern neural network architectures. | ![TensorFlow](https://img.shields.io/badge/TensorFlow-FF6F00?style=flat-square&logo=tensorflow) ![Keras](https://img.shields.io/badge/Keras-D00000?style=flat-square&logo=keras&logoColor=white) | [View](https://github.com/Rahulk9520/Deep-Learning) |
| CV-Speech-Processing | Comprehensive projects in computer vision and speech processing: image preprocessing, object detection, feature extraction, speech emotion recognition, and more, using OpenCV, scikit-learn, and Librosa. | ![OpenCV](https://img.shields.io/badge/OpenCV-5C3EE8?style=flat-square&logo=opencv&logoColor=white) ![scikit-learn](https://img.shields.io/badge/scikit--learn-F7931E?style=flat-square&logo=scikit-learn) ![Librosa](https://img.shields.io/badge/Librosa-5A4FCF?style=flat-square) | [View](https://github.com/Rahulk9520/CV-Speech-Processing) |
